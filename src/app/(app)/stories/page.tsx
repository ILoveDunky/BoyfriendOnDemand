...
import { storyCategories } from '@/lib/data';
    ...
    <div className="container mx-auto">
      ...
      <Card className="bg-background/80">
        <CardHeader>
            ...
            <CardDescription>Pick a category and a story to listen to.</CardDescription>
        </CardHeader>
        <div className="p-2 sm:p-6">
            <Accordion type="single" collapsible className="w-full" defaultValue={storyCategories[0]?.id}>
